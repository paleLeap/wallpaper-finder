...
# would go nowhere. This program's stdout is the only instrument anyone has
# for what its page did, so it is kept -- inside this folder, not in ~/.cache,
...
# holds on both systems and however the program was started -- menu, terminal
# or shortcut.
set -uo pipefail
